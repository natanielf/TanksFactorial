...
public class Music implements Runnable {
	...
	/**
	 * Create a music object from a given file name. The music file should be stored
	 * outside of the src folder but in the same project.
	 * 
	...
	/*
	 * Start the music. If the object was created with loops set to true then it
	 * will loop otherwise it will be played once.
	 */
	public void play() {
		if (loops == false) {
			audioClip.start();
